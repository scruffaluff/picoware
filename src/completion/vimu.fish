...
# virsh
complete -c virsh -n __fish_use_subcommand -x
complete -c virsh -n __fish_use_subcommand -l connect -s -x -d "Specify hypervisor connection URI"
complete -c virsh -n __fish_use_subcommand -l debug -s d -x -a "0\t 1\t 2\t 3\t 4\t" -d "Specify debug level (0-4)"
complete -c virsh -n __fish_use_subcommand -l help -s h -d "Show help and exit"
complete -c virsh -n __fish_use_subcommand -l keepalive-interval -s k -x -a "0\tDisable\ keepalive" -d "Set keepalive interval (secs)"
complete -c virsh -n __fish_use_subcommand -l keepalive-count -s K -x -d "Set number of possible missed keepalive messages"
complete -c virsh -n __fish_use_subcommand -l log -s l -r -d "Output logging to file"
complete -c virsh -n __fish_use_subcommand -l quiet -s q -d "Quiet mode"
complete -c virsh -n __fish_use_subcommand -l readonly -s r -d "Connect readonly"
complete -c virsh -n __fish_use_subcommand -l timing -s t -d "Show timing information"
complete -c virsh -n __fish_use_subcommand -s v -d "Show short version and exit"
complete -c virsh -n __fish_use_subcommand -s V -d "Show short version and exit"
complete -c virsh -n __fish_use_subcommand -l version -a "short\tShort\ version long\tLong\ version" -d "Show version"

# virsh attach-device
complete -c virsh -n __fish_use_subcommand -a attach-device -d "Attach device from an XML file"
...
# virsh attach-disk
complete -c virsh -n __fish_use_subcommand -a attach-disk -d "Attach disk device"
...
complete -c virsh -n __fish_use_subcommand -a attach-interface -d "Attach network interface"
...
# virsh autostart
complete -c virsh -n __fish_use_subcommand -a autostart -d "Autostart a domain"
...
# virsh blkdeviotune
complete -c virsh -n __fish_use_subcommand -a blkdeviotune -d "Set or query a block device I/O tuning parameters"
...
# virsh blkiotune
complete -c virsh -n __fish_use_subcommand -a blkiotune -d "Get or set blkio parameters"
...
# virsh blockcommit
complete -c virsh -n __fish_use_subcommand -a blockcommit -d "Start a block commit operation"
...
# virsh blockcopy
complete -c virsh -n __fish_use_subcommand -a blockcopy -d "Start a block copy operation"
...
# virsh blockjob
complete -c virsh -n __fish_use_subcommand -a blockjob -d "Manage active block operations"
...
# virsh blockpull
complete -c virsh -n __fish_use_subcommand -a blockpull -d "Populate a disk from its backing image"
...
# virsh blockresize
complete -c virsh -n __fish_use_subcommand -a blockresize -d "Resize block device of domain"

# virsh change-media
complete -c virsh -n __fish_use_subcommand -a change-media -d "Change media of CD or floppy drive"
...
# virsh console
complete -c virsh -n __fish_use_subcommand -a console -d "Connect to the guest console"
...
# virsh cpu-baseline
complete -c virsh -n __fish_use_subcommand -a cpu-baseline -d "Compute baseline CPU"
...
# virsh cpu-compare
complete -c virsh -n __fish_use_subcommand -a cpu-compare -d "Compare host CPU with a CPU described by an XML file"
complete -c virsh -n "__fish_seen_subcommand_from cpu-compare" -l error -d "Report error if CPUs are incompatible"

# virsh cpu-stats
complete -c virsh -n __fish_use_subcommand -a cpu-stats -d "Show domain cpu statistics"
...
# virsh create
complete -c virsh -n __fish_use_subcommand -a create -d "Create a domain from an XML file"
...
# virsh define
complete -c virsh -n __fish_use_subcommand -a define -d "Define (but don't start) a domain"
complete -c virsh -n "__fish_seen_subcommand_from define" -l validate -d "Validate the XML against the schema"

# virsh desc
complete -c virsh -n __fish_use_subcommand -a desc -d "Show or set domain's description or title"
...
# virsh destroy
complete -c virsh -n __fish_use_subcommand -a destroy -d "Destroy (stop) a domain"
complete -c virsh -n "__fish_seen_subcommand_from destroy" -l graceful -d "Terminate gracefully"

# virsh detach-device
complete -c virsh -n __fish_use_subcommand -a detach-device -d "Detach device from an XML file"
...
# virsh detach-disk
complete -c virsh -n __fish_use_subcommand -a detach-disk -d "Detach disk device"
...
complete -c virsh -n __fish_use_subcommand -a detach-interface -d "Detach network interface"
...
# virsh domdisplay
complete -c virsh -n __fish_use_subcommand -a domdisplay -d "Domain display connection URI"
...
# virsh domfsfreeze
complete -c virsh -n __fish_use_subcommand -a domfsfreeze -d "Freeze domain's mounted filesystems"

# virsh domfsthaw
complete -c virsh -n __fish_use_subcommand -a domfsthaw -d "Thaw domain's mounted filesystems"

# virsh domfsinfo
complete -c virsh -n __fish_use_subcommand -a domfsinfo -d "Get information of domain's mounted filesystems"

# virsh domfstrim
complete -c virsh -n __fish_use_subcommand -a domfstrim -d "Invoke fstrim on domain's mounted filesystems"
...
# virsh domhostname
complete -c virsh -n __fish_use_subcommand -a domhostname -d "Print the domain's hostname"

# virsh domid
complete -c virsh -n __fish_use_subcommand -a domid -d "Convert a domain name or UUID to domain id"

# virsh domif-setlink
complete -c virsh -n __fish_use_subcommand -a domif-setlink -d "Set link state of a virtual interface"
complete -c virsh -n "__fish_seen_subcommand_from domif-setlink" -l config -d "Affect next boot"

# virsh domiftune
complete -c virsh -n __fish_use_subcommand -a domiftune -d "Get/set parameters of a virtual interface"
...
# virsh domjobabort
complete -c virsh -n __fish_use_subcommand -a domjobabort -d "Abort active domain job"

# virsh domjobinfo
complete -c virsh -n __fish_use_subcommand -a domjobinfo -d "Domain job information"
complete -c virsh -n "__fish_seen_subcommand_from domjobinfo" -l completed -d "Return statistics of a recently completed job"

# virsh domname
complete -c virsh -n __fish_use_subcommand -a domname -d "Convert a domain id or UUID to domain name"

# virsh domrename
complete -c virsh -n __fish_use_subcommand -a domrename -d "Rename a domain"
complete -c virsh -n "__fish_seen_subcommand_from domrename" -a '(__fish_virsh_get_domains)' -x

# virsh dompmsuspend
complete -c virsh -n __fish_use_subcommand -a dompmsuspend -d "Suspend a domain gracefully using power management functions"
...
# virsh dompmwakeup
complete -c virsh -n __fish_use_subcommand -a dompmwakeup -d "Wakeup a domain from pmsuspended state"
complete -c virsh -n "__fish_seen_subcommand_from dompmwakeup" -a '(__fish_virsh_get_domains paused)' -x

# virsh domuuid
complete -c virsh -n __fish_use_subcommand -a domuuid -d "Convert a domain name or id to domain UUID"
complete -c virsh -n "__fish_seen_subcommand_from domuuid" -a '(__fish_virsh_get_domains)' -x

# virsh domxml-from-native
complete -c virsh -n __fish_use_subcommand -a domxml-from-native -d "Convert native config to domain XML"

# virsh domxml-to-native
complete -c virsh -n __fish_use_subcommand -a domxml-to-native -d "Convert domain XML to native config"
...
# virsh dump
complete -c virsh -n __fish_use_subcommand -a dump -d "Dump the core of a domain to a file for analysis"
...
# virsh dumpxml
complete -c virsh -n __fish_use_subcommand -a dumpxml -d "Domain information in XML"
...
# virsh edit
complete -c virsh -n __fish_use_subcommand -a edit -d "Edit XML configuration for a domain"
...
# virsh event
complete -c virsh -n __fish_use_subcommand -a event -d "Domain Events"
...
# virsh inject-nmi
complete -c virsh -n __fish_use_subcommand -a inject-nmi -d "Inject NMI to the guest"

# virsh iothreadinfo
complete -c virsh -n __fish_use_subcommand -a iothreadinfo -d "View domain IOThreads"
...
# virsh iothreadpin
complete -c virsh -n __fish_use_subcommand -a iothreadpin -d "Control domain IOThread affinity"
...
# virsh iothreadadd
complete -c virsh -n __fish_use_subcommand -a iothreadadd -d "Add an IOThread to the guest domain"
...
# virsh iothreaddel
complete -c virsh -n __fish_use_subcommand -a iothreaddel -d "Delete an IOThread from the guest domain"
...
# virsh send-key
complete -c virsh -n __fish_use_subcommand -a send-key -d "Send keycodes to the guest"
...
complete -c virsh -n __fish_use_subcommand -a send-process-signal -d "Send signals to processes"

# virsh lxc-enter-namespace
complete -c virsh -n __fish_use_subcommand -a lxc-enter-namespace -d "LXC Guest Enter Namespace"
complete -c virsh -n "__fish_seen_subcommand_from lxc-enter-namespace" -l noseclabel -d "Do not change process security label"

# virsh managedsave
complete -c virsh -n __fish_use_subcommand -a managedsave -d "Managed save of a domain state"
...
complete -c virsh -n __fish_use_subcommand -a managedsave-remove -d "Remove managed save of a domain"

# virsh managedsave-edit
complete -c virsh -n __fish_use_subcommand -a managedsave-edit -d "Edit XML for a domain's managed save state file"
...
complete -c virsh -n __fish_use_subcommand -a managedsave-dumpxml -d "Domain information of managed save state file in XML"
...
complete -c virsh -n __fish_use_subcommand -a managedsave-define -d "Redefine the XML for a domain's managed save state file"
...
# virsh memtune
complete -c virsh -n __fish_use_subcommand -a memtune -d "Get or set memory parameters"
...
# virsh perf
complete -c virsh -n __fish_use_subcommand -a perf -d "Get or set perf event"
...
# virsh metadata
complete -c virsh -n __fish_use_subcommand -a metadata -d "Show or set domain's custom XML metadata"
...
# virsh migrate
complete -c virsh -n __fish_use_subcommand -a migrate -d "Migrate domain to another host"
...
complete -c virsh -n __fish_use_subcommand -a migrate-setmaxdowntime -d "Set maximum tolerable downtime"

# virsh migrate-getmaxdowntime
complete -c virsh -n __fish_use_subcommand -a migrate-getmaxdowntime -d "Get maximum tolerable downtime"

# virsh migrate-compcache
complete -c virsh -n __fish_use_subcommand -a migrate-compcache -d "Get/set compression cache size"
...
complete -c virsh -n __fish_use_subcommand -a migrate-setspeed -d "Set the maximum migration bandwidth"

# virsh migrate-getspeed
complete -c virsh -n __fish_use_subcommand -a migrate-getspeed -d "Get the maximum migration bandwidth"

# virsh migrate-postcopy
complete -c virsh -n __fish_use_subcommand -a migrate-postcopy -d "Switch running migration from pre-copy to post-copy"

# virsh numatune
complete -c virsh -n __fish_use_subcommand -a numatune -d "Get or set numa parameters"
...
# virsh qemu-attach
complete -c virsh -n __fish_use_subcommand -a qemu-attach -d "QEMU Attach"

# virsh qemu-monitor-command
complete -c virsh -n __fish_use_subcommand -a qemu-monitor-command -d "QEMU Monitor Command"
...
complete -c virsh -n __fish_use_subcommand -a qemu-monitor-event -d "QEMU Monitor Events"
...
complete -c virsh -n __fish_use_subcommand -a qemu-agent-command -d "QEMU Guest Agent Command"
...
# virsh reboot
complete -c virsh -n __fish_use_subcommand -a reboot -d "Reboot a domain"
...
# virsh reset
complete -c virsh -n __fish_use_subcommand -a reset -d "Reset a domain"

# virsh restore
complete -c virsh -n __fish_use_subcommand -a restore -d "Restore a domain from a saved state in a file"
...
# virsh resume
complete -c virsh -n __fish_use_subcommand -a resume -d "Resume a domain"
complete -c virsh -n "__fish_seen_subcommand_from resume" -a '(__fish_virsh_get_domains paused)' -x

# virsh save
complete -c virsh -n __fish_use_subcommand -a save -d "Save a domain state to a file"
...
complete -c virsh -n __fish_use_subcommand -a save-image-define -d "Redefine the XML for a domain's saved state file"
...
complete -c virsh -n __fish_use_subcommand -a save-image-dumpxml -d "Saved state domain information in XML"
...
complete -c virsh -n __fish_use_subcommand -a save-image-edit -d "Edit XML for a domain's saved state file"
...
# virsh schedinfo
complete -c virsh -n __fish_use_subcommand -a schedinfo -d "Show/set scheduler parameters"
...
# virsh screenshot
complete -c virsh -n __fish_use_subcommand -a screenshot -d "Take a screenshot of a current domain console and store it into a file"
...
complete -c virsh -n __fish_use_subcommand -a set-lifecycle-action -d "Change lifecycle actions"
...
complete -c virsh -n __fish_use_subcommand -a set-user-password -d "Set the user password inside the domain"
complete -c virsh -n "__fish_seen_subcommand_from set-user-password" -l encrypted -d "The password is already encrypted"

# virsh setmaxmem
complete -c virsh -n __fish_use_subcommand -a setmaxmem -d "Change maximum memory limit"
...
# virsh setmem
complete -c virsh -n __fish_use_subcommand -a setmem -d "Change memory allocation"
...
# virsh setvcpus
complete -c virsh -n __fish_use_subcommand -a setvcpus -d "Change number of virtual CPUs"
...
# virsh shutdown
complete -c virsh -n __fish_use_subcommand -a shutdown -d "Gracefully shutdown a domain"
...
# virsh start
complete -c virsh -n __fish_use_subcommand -a start -d "Start a (previously defined) inactive domain"
...
# virsh suspend
complete -c virsh -n __fish_use_subcommand -a suspend -d "Suspend a domain"
complete -c virsh -n "__fish_seen_subcommand_from suspend" -a '(__fish_virsh_get_domains running)' -x

# virsh ttyconsole
complete -c virsh -n __fish_use_subcommand -a ttyconsole -d "TTY console"

# virsh undefine
complete -c virsh -n __fish_use_subcommand -a undefine -d "Undefine a domain"
...
# virsh update-device
complete -c virsh -n __fish_use_subcommand -a update-device -d "Update device from an XML file"
...
# virsh vcpucount
complete -c virsh -n __fish_use_subcommand -a vcpucount -d "Domain vcpu counts"
...
# virsh vcpuinfo
complete -c virsh -n __fish_use_subcommand -a vcpuinfo -d "Detailed domain vcpu information"
complete -c virsh -n "__fish_seen_subcommand_from vcpuinfo" -l pretty -d "Return human readable output"

# virsh vcpupin
complete -c virsh -n __fish_use_subcommand -a vcpupin -d "Control or query domain vcpu affinity"
...
# virsh emulatorpin
complete -c virsh -n __fish_use_subcommand -a emulatorpin -d "Control or query domain emulator affinity"
...
# virsh vncdisplay
complete -c virsh -n __fish_use_subcommand -a vncdisplay -d "Vnc display"

# virsh guestvcpus
complete -c virsh -n __fish_use_subcommand -a guestvcpus -d "Query or modify state of vcpu in the guest (via agent)"
...
# virsh setvcpu
complete -c virsh -n __fish_use_subcommand -a setvcpu -d "Attach/detach vcpu or groups of threads"
...
complete -c virsh -n __fish_use_subcommand -a domblkthreshold -d "Set the threshold for block-threshold event"

# virsh domblkerror
complete -c virsh -n __fish_use_subcommand -a domblkerror -d "Show errors on block devices"

# virsh domblkinfo
complete -c virsh -n __fish_use_subcommand -a domblkinfo -d "Domain block device size information"
complete -c virsh -n "__fish_seen_subcommand_from domblkinfo" -l human -d "Human readable output"

# virsh domblklist
complete -c virsh -n __fish_use_subcommand -a domblklist -d "List all domain blocks"
...
# virsh domblkstat
complete -c virsh -n __fish_use_subcommand -a domblkstat -d "Get device block stats for a domain"
...
# virsh domcontrol
complete -c virsh -n __fish_use_subcommand -a domcontrol -d "Domain control interface state"

# virsh domif-getlink
complete -c virsh -n __fish_use_subcommand -a domif-getlink -d "Get link state of a virtual interface"
complete -c virsh -n "__fish_seen_subcommand_from domif-getlink" -l config -d "Get persistent interface state"

# virsh domifaddr
complete -c virsh -n __fish_use_subcommand -a domifaddr -d "Get network interfaces' addresses for a running domain"
...
# virsh domiflist
complete -c virsh -n __fish_use_subcommand -a domiflist -d "List all domain virtual interfaces"
complete -c virsh -n "__fish_seen_subcommand_from domiflist" -l inactive -d "Get inactive rather than running configuration"

# virsh domifstat
complete -c virsh -n __fish_use_subcommand -a domifstat -d "Get network interface stats for a domain"

# virsh dominfo
complete -c virsh -n __fish_use_subcommand -a dominfo -d "Domain information"

# virsh dommemstat
complete -c virsh -n __fish_use_subcommand -a dommemstat -d "Get memory statistics for a domain"
...
# virsh domstate
complete -c virsh -n __fish_use_subcommand -a domstate -d "Domain state"
complete -c virsh -n "__fish_seen_subcommand_from domstate" -l reason -d "Also print reason for the state"

# virsh domstats
complete -c virsh -n __fish_use_subcommand -a domstats -d "Get statistics about one or multiple domains"
...
# virsh domtime
complete -c virsh -n __fish_use_subcommand -a domtime -d "Domain time"
...
# virsh list
complete -c virsh -n __fish_use_subcommand -a list -d "List domains"
...
# virsh allocpages
complete -c virsh -n __fish_use_subcommand -a allocpages -d "Manipulate pages pool size"
...
# virsh capabilities
complete -c virsh -n __fish_use_subcommand -a capabilities -d Capabilities

# virsh cpu-models
complete -c virsh -n __fish_use_subcommand -a cpu-models -d "CPU models"

# virsh domcapabilities
complete -c virsh -n __fish_use_subcommand -a domcapabilities -d "Domain capabilities"
...
# virsh freecell
complete -c virsh -n __fish_use_subcommand -a freecell -d "NUMA free memory"
...
# virsh freepages
complete -c virsh -n __fish_use_subcommand -a freepages -d "NUMA free pages"
...
# virsh hostname
complete -c virsh -n __fish_use_subcommand -a hostname -d "Print the hypervisor hostname"

# virsh maxvcpus
complete -c virsh -n __fish_use_subcommand -a maxvcpus -d "Connection vcpu maximum"
complete -c virsh -n "__fish_seen_subcommand_from maxvcpus" -l type -d "Domain type"

# virsh node-memory-tune
complete -c virsh -n __fish_use_subcommand -a node-memory-tune -d "Get or set node memory parameters"
...
# virsh nodecpumap
complete -c virsh -n __fish_use_subcommand -a nodecpumap -d "Node cpu map"
complete -c virsh -n "__fish_seen_subcommand_from nodecpumap" -l pretty -d "Return human readable output"

# virsh nodecpustats
complete -c virsh -n __fish_use_subcommand -a nodecpustats -d "Prints cpu stats of the node"
...
# virsh nodeinfo
complete -c virsh -n __fish_use_subcommand -a nodeinfo -d "Node information"

# virsh nodememstats
complete -c virsh -n __fish_use_subcommand -a nodememstats -d "Prints memory stats of the node"
complete -c virsh -n "__fish_seen_subcommand_from nodememstats" -l cell -d "Prints specified cell statistics only"

# virsh nodesuspend
complete -c virsh -n __fish_use_subcommand -a nodesuspend -d "Suspend the host node for a given time duration"

# virsh sysinfo
complete -c virsh -n __fish_use_subcommand -a sysinfo -d "Print the hypervisor sysinfo"

# virsh uri
complete -c virsh -n __fish_use_subcommand -a uri -d "Print the hypervisor canonical URI"

# virsh version
complete -c virsh -n __fish_use_subcommand -a version -d "Show version"
complete -c virsh -n "__fish_seen_subcommand_from version" -l daemon -d "Report daemon version too"

# virsh iface-begin
complete -c virsh -n __fish_use_subcommand -a iface-begin -d "Create a snapshot of current interfaces settings"

# virsh iface-bridge
complete -c virsh -n __fish_use_subcommand -a iface-bridge -d "Create a bridge device and attach an existing network device to it"
...
# virsh iface-commit
complete -c virsh -n __fish_use_subcommand -a iface-commit -d "Commit changes made since iface-begin and free restore point"

# virsh iface-define
complete -c virsh -n __fish_use_subcommand -a iface-define -d "Define or modify an inactive persistent physical host interface"

# virsh iface-destroy
complete -c virsh -n __fish_use_subcommand -a iface-destroy -d "Destroy a physical host interface"

# virsh iface-dumpxml
complete -c virsh -n __fish_use_subcommand -a iface-dumpxml -d "Interface information in XML"
complete -c virsh -n "__fish_seen_subcommand_from iface-dumpxml" -l inactive -d "Show inactive defined XML"

# virsh iface-edit
complete -c virsh -n __fish_use_subcommand -a iface-edit -d "Edit XML configuration for a physical host interface"

# virsh iface-list
complete -c virsh -n __fish_use_subcommand -a iface-list -d "List physical host interfaces"
...
# virsh iface-mac
complete -c virsh -n __fish_use_subcommand -a iface-mac -d "Convert an interface name to interface MAC address"

# virsh iface-name
complete -c virsh -n __fish_use_subcommand -a iface-name -d "Convert an interface MAC address to interface name"

# virsh iface-rollback
complete -c virsh -n __fish_use_subcommand -a iface-rollback -d "Rollback to previous saved configuration created via iface-begin"

# virsh iface-start
complete -c virsh -n __fish_use_subcommand -a iface-start -d "Start a physical host interface"

# virsh iface-unbridge
complete -c virsh -n __fish_use_subcommand -a iface-unbridge -d "Undefine a bridge device after detaching its slave device"
...
complete -c virsh -n __fish_use_subcommand -a iface-undefine -d "Undefine a physical host interface"

# virsh nwfilter-define
complete -c virsh -n __fish_use_subcommand -a nwfilter-define -d "Define or update a network filter"

# virsh nwfilter-dumpxml
complete -c virsh -n __fish_use_subcommand -a nwfilter-dumpxml -d "Network filter information in XML"

# virsh nwfilter-edit
complete -c virsh -n __fish_use_subcommand -a nwfilter-edit -d "Edit XML configuration for a network filter"

# virsh nwfilter-list
complete -c virsh -n __fish_use_subcommand -a nwfilter-list -d "List network filters"

# virsh nwfilter-undefine
complete -c virsh -n __fish_use_subcommand -a nwfilter-undefine -d "Undefine a network filter"

# virsh net-autostart
complete -c virsh -n __fish_use_subcommand -a net-autostart -d "Autostart a network"
...
# virsh net-create
complete -c virsh -n __fish_use_subcommand -a net-create -d "Create a network from an XML file"

# virsh net-define
complete -c virsh -n __fish_use_subcommand -a net-define -d "Define or modify an inactive persistent virtual network"

# virsh net-destroy
complete -c virsh -n __fish_use_subcommand -a net-destroy -d "Destroy (stop) a network"
complete -c virsh -n "__fish_seen_subcommand_from net-destroy" -x -a '(__fish_virsh_get_networks active)'

# virsh net-dhcp-leases
complete -c virsh -n __fish_use_subcommand -a net-dhcp-leases -d "Print lease info for a given network"
...
# virsh net-dumpxml
complete -c virsh -n __fish_use_subcommand -a net-dumpxml -d "Network information in XML"
...
# virsh net-edit
complete -c virsh -n __fish_use_subcommand -a net-edit -d "Edit XML configuration for a network"
complete -c virsh -n "__fish_seen_subcommand_from net-edit" -x -a '(__fish_virsh_get_networks)'

# virsh net-event
complete -c virsh -n __fish_use_subcommand -a net-event -d "Network Events"
...
# virsh net-info
complete -c virsh -n __fish_use_subcommand -a net-info -d "Network information"
complete -c virsh -n "__fish_seen_subcommand_from net-info" -x -a '(__fish_virsh_get_networks)'

# virsh net-list
complete -c virsh -n __fish_use_subcommand -a net-list -d "List networks"
...
# virsh net-name
complete -c virsh -n __fish_use_subcommand -a net-name -d "Convert a network UUID to network name"

# virsh net-start
complete -c virsh -n __fish_use_subcommand -a net-start -d "Start a (previously defined) inactive network"
complete -c virsh -n "__fish_seen_subcommand_from net-start" -x -a '(__fish_virsh_get_networks inactive)'

# virsh net-undefine
complete -c virsh -n __fish_use_subcommand -a net-undefine -d "Undefine a persistent network"
complete -c virsh -n "__fish_seen_subcommand_from net-undefine" -x -a '(__fish_virsh_get_networks)'

# virsh net-update
complete -c virsh -n __fish_use_subcommand -a net-update -d "Update parts of an existing network's configuration"
...
# virsh net-uuid
complete -c virsh -n __fish_use_subcommand -a net-uuid -d "Convert a network name to network UUID"
complete -c virsh -n "__fish_seen_subcommand_from net-uuid" -x -a '(__fish_virsh_get_networks)'

# virsh nodedev-create
complete -c virsh -n __fish_use_subcommand -a nodedev-create -d "Create a device defined by an XML file on the node"

# virsh nodedev-destroy
complete -c virsh -n __fish_use_subcommand -a nodedev-destroy -d "Destroy (stop) a device on the node"

# virsh nodedev-detach
complete -c virsh -n __fish_use_subcommand -a nodedev-detach -d "Detach node device from its device driver"
...
complete -c virsh -n __fish_use_subcommand -a nodedev-dumpxml -d "Node device details in XML"

# virsh nodedev-list
complete -c virsh -n __fish_use_subcommand -a nodedev-list -d "Enumerate devices on this host"
...
complete -c virsh -n __fish_use_subcommand -a nodedev-reattach -d "Reattach node device to its device driver"

# virsh nodedev-reset
complete -c virsh -n __fish_use_subcommand -a nodedev-reset -d "Reset node device"

# virsh nodedev-event
complete -c virsh -n __fish_use_subcommand -a nodedev-event -d "Node Device Events"
...
# virsh secret-define
complete -c virsh -n __fish_use_subcommand -a secret-define -d "Define or modify a secret"

# virsh secret-dumpxml
complete -c virsh -n __fish_use_subcommand -a secret-dumpxml -d "Secret attributes in XML"

# virsh secret-event
complete -c virsh -n __fish_use_subcommand -a secret-event -d "Secret Events"
...
complete -c virsh -n __fish_use_subcommand -a secret-get-value -d "Output a secret value"

# virsh secret-list
complete -c virsh -n __fish_use_subcommand -a secret-list -d "List secrets"
...
complete -c virsh -n __fish_use_subcommand -a secret-set-value -d "Set a secret value"

# virsh secret-undefine
complete -c virsh -n __fish_use_subcommand -a secret-undefine -d "Undefine a secret"

# virsh snapshot-create
complete -c virsh -n __fish_use_subcommand -a snapshot-create -d "Create a snapshot from XML"
...
complete -c virsh -n __fish_use_subcommand -a snapshot-create-as -d "Create a snapshot from a set of args"
...
complete -c virsh -n __fish_use_subcommand -a snapshot-current -d "Get or set the current snapshot"
...
complete -c virsh -n __fish_use_subcommand -a snapshot-delete -d "Delete a domain snapshot"
...
complete -c virsh -n __fish_use_subcommand -a snapshot-dumpxml -d "Dump XML for a domain snapshot"
...
# virsh snapshot-edit
complete -c virsh -n __fish_use_subcommand -a snapshot-edit -d "Edit XML for a snapshot"
...
# virsh snapshot-info
complete -c virsh -n __fish_use_subcommand -a snapshot-info -d "Snapshot information"
...
# virsh snapshot-list
complete -c virsh -n __fish_use_subcommand -a snapshot-list -d "List snapshots for a domain"
...
complete -c virsh -n __fish_use_subcommand -a snapshot-parent -d "Get the name of the parent of a snapshot"
...
complete -c virsh -n __fish_use_subcommand -a snapshot-revert -d "Revert a domain to a snapshot"
...
complete -c virsh -n __fish_use_subcommand -a find-storage-pool-sources-as -d "Find potential storage pool sources"
...
complete -c virsh -n __fish_use_subcommand -a find-storage-pool-sources -d "Discover potential storage pool sources"
...
complete -c virsh -n __fish_use_subcommand -a pool-autostart -d "Autostart a pool"
complete -c virsh -n "__fish_seen_subcommand_from pool-autostart" -l disable -d "Disable autostarting"

# virsh pool-build
complete -c virsh -n __fish_use_subcommand -a pool-build -d "Build a pool"
...
complete -c virsh -n __fish_use_subcommand -a pool-create-as -d "Create a pool from a set of args"
...
# virsh pool-create
complete -c virsh -n __fish_use_subcommand -a pool-create -d "Create a pool from an XML file"
...
complete -c virsh -n __fish_use_subcommand -a pool-define-as -d "Define a pool from a set of args"
...
# virsh pool-define
complete -c virsh -n __fish_use_subcommand -a pool-define -d "Define or modify an inactive persistent storage pool"

# virsh pool-delete
complete -c virsh -n __fish_use_subcommand -a pool-delete -d "Delete a pool"

# virsh pool-destroy
complete -c virsh -n __fish_use_subcommand -a pool-destroy -d "Destroy (stop) a pool"

# virsh pool-dumpxml
complete -c virsh -n __fish_use_subcommand -a pool-dumpxml -d "Pool information in XML"
complete -c virsh -n "__fish_seen_subcommand_from pool-dumpxml" -l inactive -d "Show inactive defined XML"

# virsh pool-edit
complete -c virsh -n __fish_use_subcommand -a pool-edit -d "Edit XML configuration for a storage pool"

# virsh pool-info
complete -c virsh -n __fish_use_subcommand -a pool-info -d "Storage pool information"
complete -c virsh -n "__fish_seen_subcommand_from pool-info" -l bytes -d "Reture pool info in bytes"

# virsh pool-list
complete -c virsh -n __fish_use_subcommand -a pool-list -d "List pools"
...
# virsh pool-name
complete -c virsh -n __fish_use_subcommand -a pool-name -d "Convert a pool UUID to pool name"

# virsh pool-refresh
complete -c virsh -n __fish_use_subcommand -a pool-refresh -d "Refresh a pool"

# virsh pool-start
complete -c virsh -n __fish_use_subcommand -a pool-start -d "Start a (previously defined) inactive pool"
...
# virsh pool-undefine
complete -c virsh -n __fish_use_subcommand -a pool-undefine -d "Undefine an inactive pool"

# virsh pool-uuid
complete -c virsh -n __fish_use_subcommand -a pool-uuid -d "Convert a pool name to pool UUID"

# virsh pool-event
complete -c virsh -n __fish_use_subcommand -a pool-event -d "Storage Pool Events"
...
# virsh vol-clone
complete -c virsh -n __fish_use_subcommand -a vol-clone -d "Clone a volume"
...
# virsh vol-create-as
complete -c virsh -n __fish_use_subcommand -a vol-create-as -d "Create a volume from a set of args"
...
# virsh vol-create
complete -c virsh -n __fish_use_subcommand -a vol-create -d "Create a vol from an XML file"
...
complete -c virsh -n __fish_use_subcommand -a vol-create-from -d "Create a vol, using another volume as input"
...
# virsh vol-delete
complete -c virsh -n __fish_use_subcommand -a vol-delete -d "Delete a vol"
...
# virsh vol-download
complete -c virsh -n __fish_use_subcommand -a vol-download -d "Download volume contents to a file"
...
# virsh vol-dumpxml
complete -c virsh -n __fish_use_subcommand -a vol-dumpxml -d "Vol information in XML"
complete -c virsh -n "__fish_seen_subcommand_from vol-dumpxml" -l pool -d "Pool name or UUID"

# virsh vol-info
complete -c virsh -n __fish_use_subcommand -a vol-info -d "Storage vol information"
...
# virsh vol-key
complete -c virsh -n __fish_use_subcommand -a vol-key -d "Returns the volume key for a given volume name or path"
complete -c virsh -n "__fish_seen_subcommand_from vol-key" -l pool -d "Pool name or UUID"

# virsh vol-list
complete -c virsh -n __fish_use_subcommand -a vol-list -d "List vols"
complete -c virsh -n "__fish_seen_subcommand_from vol-list" -l details -d "Display extended details for volumes"

# virsh vol-name
complete -c virsh -n __fish_use_subcommand -a vol-name -d "Returns the volume name for a given volume key or path"

# virsh vol-path
complete -c virsh -n __fish_use_subcommand -a vol-path -d "Returns the volume path for a given volume name or key"
complete -c virsh -n "__fish_seen_subcommand_from vol-path" -l pool -d "Pool name or UUID"

# virsh vol-pool
complete -c virsh -n __fish_use_subcommand -a vol-pool -d "Returns the storage pool for a given volume key or path"
complete -c virsh -n "__fish_seen_subcommand_from vol-pool" -l uuid -d "Return the pool UUID rather than pool name"

# virsh vol-resize
complete -c virsh -n __fish_use_subcommand -a vol-resize -d "Resize a vol"
...
# virsh vol-upload
complete -c virsh -n __fish_use_subcommand -a vol-upload -d "Upload file contents to a volume"
...
# virsh vol-wipe
complete -c virsh -n __fish_use_subcommand -a vol-wipe -d "Wipe a vol"
